...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_servicetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('users', ['ServiceType'])

        # Adding model 'Service'
        db.create_table('users_service', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.ServiceType'])),
        ...
        db.send_create_signal('users', ['Service'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_servicetype')
    ...
    models = {
        ...
        'users.service': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.UserProfile']"}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.ServiceType']"}),
