...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Guide', fields ['user']
        db.delete_unique('guides_guide', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Guide', fields ['user']
        db.create_unique('guides_guide', ['user_id'])
