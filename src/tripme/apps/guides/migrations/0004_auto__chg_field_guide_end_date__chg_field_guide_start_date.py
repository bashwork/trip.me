...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Guide.end_date'
        db.alter_column('guides_guide', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Guide.start_date'
        db.alter_column('guides_guide', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Guide.end_date'
        db.alter_column('guides_guide', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Guide.start_date'
        db.alter_column('guides_guide', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
