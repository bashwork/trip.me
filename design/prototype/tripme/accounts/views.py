...
from mysite.accounts.forms import UserCreationForm
...
def signup(request, template_name='registration/signup.html', 
    ...
    if post_signup_redirect is None:
        post_signup_redirect = reverse('mysite.accounts.views.signup_done')
...
def signup_confirm(request, uidb36=None, token=None,
    ...
    if post_signup_redirect is None:
        post_signup_redirect = reverse('mysite.accounts.views.signup_complete')
    try:
